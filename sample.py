import torch
from muti_control.ICCR import CR
...
def process(prompt,skull_image): 
...
if __name__ == '__main__':
    ...
    # load model
    iccr_model = CR(1,use_FM,use_PiP,sd_file,pip_face_file,pip_weight_file)  
